...
return [
    ...
    'api/v1/device/devicestate/<device_type_id:\d+>' => 'api/v1/device/devicestate',
    ...
    'api/v1/device-group/getondevcount/<device_group_id:\d+>' => 'api/v1/device-group/getondevcount',
];