...
class ApiUtility {
    ...
    const G_MAPS_APIKEY = "AIzaSyBDo5cGMAUnBAgEk2gknxZncnxBoJeRdEw";
    ...
    const NAME_AIRTEL = 1;
    const NAME_ETISALAT = 2;
    const NAME_GLO = 3;
    const NAME_MTN = 4;
    const NAME_UNKNOWN = 5;
    ...
    public static function getNetworkId($name)
    {
        if ((preg_match("/airtel/i", $name)) || (preg_match("/zain/i", $name)) || (preg_match("/celtel/i", $name))) {
            return self::NAME_AIRTEL;
        } elseif ((preg_match("/emts/i", $name)) || (preg_match("/eti/i", $name))) {
            return self::NAME_ETISALAT;
        } elseif (preg_match("/glo/i", $name)) {
            return self::NAME_GLO;
        } elseif (preg_match("/mtn/i", $name)) {
            return self::NAME_MTN;
        } else {
